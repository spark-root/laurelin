 ...
 * the executor
 */
class PartitionDefinition implements InputPartition<ColumnarBatch> {
    ...
    public PartitionDefinition(StructType schema, CacheFactory basketCacheFactory, long entryStart, long entryEnd, Map<String, SlimTBranch> slimBranches, int threadCount, CollectionAccumulator<Storage> profileData, int pid) {
